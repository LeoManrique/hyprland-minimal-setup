...
Pay attention to the warnings in [Environment variables](https://wiki.hypr.land/Configuring/Advanced-and-Cool/Environment-variables), [Multi-GPU](https://wiki.hypr.land/Configuring/Advanced-and-Cool/Multi-GPU) and [Dispatchers](https://wiki.hypr.land/Configuring/Basics/Dispatchers) sections.
...
[Hypr Ecosystem](../Hypr-Ecosystem/index.html "Hypr Ecosystem")