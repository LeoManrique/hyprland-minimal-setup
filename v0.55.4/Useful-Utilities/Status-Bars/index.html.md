...
Use the `blur` and `ignore_alpha` [layer rules](../../Configuring/Basics/Window-Rules/index.html#layer-rules).
...
[Must have](../Must-have/index.html "Must have")[Wallpapers](../Wallpapers/index.html "Wallpapers")