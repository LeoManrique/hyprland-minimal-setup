...
| cursor\_zoom | Zooms into the cursor. | `zoom_level` for a zoom factor, `mode` of `"mult"` to use a multiplier or `"live"` to update continuously during the pinch |
...
[Animations](../Animations/index.html "Animations")[Devices](../Devices/index.html "Devices")