...
[
](https://dl.hypr.land/wiki/demo_master.mp4)
...
| focus\_master\_on\_close | when enabled, closing a window focuses the master window | bool | `false` |
...
| --- | --- | --- |
| orientation = [o] | Sets the orientation of a workspace. For available orientations, see [Config->orientation](index.html#config) | string |
...
[Dwindle Layout](../Dwindle-Layout/index.html "Dwindle Layout")[Scrolling Layout](../Scrolling-Layout/index.html "Scrolling Layout")