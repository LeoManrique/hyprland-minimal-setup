...
Read the warning about using `-git` packages or compiling from source under [Installation](index.html#installation) first!
...
[“Manual (Manual Build)”](index.html#manual) to build Hyprland yourself.
...
Ubuntu’s Hyprland is **extremely** outdated. I do not recommend using the packaged versions at all. Build the entire stack [manually](index.html#manual) instead.
...
*Unfortunately, `xdg-desktop-portal-hyprland` is still not in Ubuntu Repo so you have to build it from source*
...
[installing hyprland-git from the aur](index.html#installation) or
[building manually](index.html#manual).
...
[Master tutorial](../Master-Tutorial/index.html "Master tutorial")