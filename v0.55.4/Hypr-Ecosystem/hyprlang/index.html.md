...
You can use `+`, `-`, `*`, or `/`, on only *two* variables (or constants) at a time.  
...
[hyprutils](../hyprutils/index.html "hyprutils")[hyprwayland-scanner](../hyprwayland-scanner/index.html "hyprwayland-scanner")