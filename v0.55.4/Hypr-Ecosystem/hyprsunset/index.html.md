...
If Hyprland is started with [uwsm](https://wiki.hypr.land/Useful-Utilities/Systemd-start), you can use `systemctl --user enable --now hyprsunset.service`.
...
[hyprsysteminfo](../hyprsysteminfo/index.html "hyprsysteminfo")[hyprpolkitagent](../hyprpolkitagent/index.html "hyprpolkitagent")