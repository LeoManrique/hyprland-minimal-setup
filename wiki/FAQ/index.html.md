...
[the Master Tutorial](../Getting-Started/Master-Tutorial/index.html#force-apps-to-use-wayland).

If they can’t, see [the XWayland page](https://wiki.hypr.land/Configuring/Advanced-and-Cool/XWayland).
...
To diagnose if you have the exact problem above you can get a [DRM log](../Crashes-and-Bugs/index.html#debugging-drm-issues) and look for
...
See [Environment Variables](https://wiki.hypr.land/Configuring/Advanced-and-Cool/Environment-variables)
...
See [The XDPH Page](../Hypr-Ecosystem/xdg-desktop-portal-hyprland/index.html#debugging).
...
[Here](../Configuring/Basics/Workspace-Rules/index.html#smart-gaps).
...
Add `xrandr --output [MONITOR_ID] --primary` to your autostarts in the config, replacing [MONITOR\_ID] with your main monitor’s ID (e.g. DP-3). You can find your monitor ID by running `hyprctl monitors`.
