...
[uwsm](https://wiki.hypr.land/Useful-Utilities/Systemd-start) users should avoid placing environment variables in the `hyprland.lua` file.  
...
[XWayland](../XWayland/index.html "XWayland")[Multi-GPU](../Multi-GPU/index.html "Multi-GPU")