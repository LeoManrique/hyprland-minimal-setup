...
[`hl.config({ xwayland = { force_zero_scaling = true } })`](../../Basics/Variables/index.html#xwayland) option,
...
Keeping that in mind, we add the [`xwayland:create_abstract_socket`](../../Basics/Variables/index.html#xwayland) option.
...
[Expanding functionality](../Expanding-functionality/index.html "Expanding functionality")[Environment variables](../Environment-variables/index.html "Environment variables")