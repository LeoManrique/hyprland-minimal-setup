...
For live event handling, see the [events](../Expanding-functionality/index.html#events).
...
See [Dispatchers](https://wiki.hypr.land/Configuring/Basics/Dispatchers) for a list of dispatchers.
...
Where `window` is as described [here](https://wiki.hypr.land/Configuring/Basics/Dispatchers#parameter-explanation), and `property` is any which can be set with [setprop](../../Basics/Dispatchers/index.html#set_prop).
...
See [Variables](https://wiki.hypr.land/Configuring/Basics/Variables) for sections and options you can use.
...
[Permissions](../Permissions/index.html "Permissions")[Notifications](../Notifications/index.html "Notifications")