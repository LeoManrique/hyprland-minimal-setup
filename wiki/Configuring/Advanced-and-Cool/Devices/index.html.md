...
For global device configs, check the [Variables](https://wiki.hypr.land/Configuring/Basics/Variables) page. This page
...
- `tags` -> (only for keyboards / pointers)
  - provides grouping and alt-names is device specific binds (see [Per-Device Binds](https://wiki.hypr.land/Configuring/Basics/Binds#per-device-binds)). comma separated list of tags
  - default: ""
...
[Gestures](../Gestures/index.html "Gestures")[Tearing](../Tearing/index.html "Tearing")