...
| workspace.special\_active | Emitted when the opened special workspace on a monitor changes. Workspace of nil means no special workspace is open. | Workspace, Monitor |
...
Use the LSP for the return values (classes and their parameters) of these functions. See [here](../../Start/index.html#autocompletions) for setting up the LSP for your code editor
...
However, if you want to use IPC instead, check the [IPC](https://wiki.hypr.land/IPC) page.

Last updated on June 12, 2026

[Notifications](../Notifications/index.html "Notifications")[XWayland](../XWayland/index.html "XWayland")