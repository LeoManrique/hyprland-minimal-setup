...
For more information have a look at [Using Hyprctl](https://wiki.hypr.land/Configuring/Advanced-and-Cool/Using-hyprctl).
...
[`send_shortcut`](../Dispatchers/index.html#dispatchers-1) dispatchers for keybinds.
...
freedom. See [Using hyprctl](https://wiki.hypr.land/Configuring/Advanced-and-Cool/Using-hyprctl).
...
To get the correct name for an `unmodified_key`, refer to [the section on uncommon syms](index.html#uncommon-syms--binding-with-a-keycode)
...
[Monitors](../Monitors/index.html "Monitors")[Dispatchers](../Dispatchers/index.html "Dispatchers")