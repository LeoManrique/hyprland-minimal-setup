...
[
](https://dl.hypr.land/wiki/demo_dwindle.mp4)
...
that value. `"splitratio 1.0 exact"` will *always* put the split in the exact center.
...
[Master Layout](../Master-Layout/index.html "Master Layout")