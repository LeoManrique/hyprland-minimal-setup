...
Please prefer :place over :set\_box unless necessary. :place will calculate the gaps,
pseudotiling, reserved space, and more, for you. set\_box is only to be used if
full manual positioning is absolutely necessary.

Last updated on June 12, 2026

[Monocle Layout](../Monocle-Layout/index.html "Monocle Layout")